...
var AjaxSendRequest = function AjaxSendRequest() {
  this.ajax_response = '';
  this.ajaxVars = {
...
var Stars = function Stars() {
  ...
  var _loop = function _loop(i) {
    _this.stars[i].addEventListener('click', function () {
          ...
          if (ajaxClient.request.responseText != null) {
            setTimeout(function () {
              try {
                ...
                for (i in childrens) {
                  if (that.hasClass(childrens[i], "checked")) childrens[i].classList.remove("checked");
                }

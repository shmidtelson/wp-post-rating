 ...
 */
class IniFileLoader extends \WPR_Vendor\Symfony\Component\DependencyInjection\Loader\FileLoader
{
    /**
     * {@inheritdoc}
     */
    public function load($resource, string $type = null)
    {
        ...
        if (\false === $result || [] === $result) {
            throw new \WPR_Vendor\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('The "%s" file is not valid.', $resource));
        }
        // real raw parsing
    ...
    private function phpize(string $value)
    {
        ...
        switch (\true) {
            ...
            default:
                return \WPR_Vendor\Symfony\Component\Config\Util\XmlUtils::phpize($value);
        }
    }
}

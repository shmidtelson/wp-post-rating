 ...
 */
class InlineServiceDefinitionsPass extends \WPR_Vendor\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    ...
    private $graph;
    public function __construct(\WPR_Vendor\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass $analyzingPass = null)
    {
    ...
    public function process(\WPR_Vendor\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        if ($this->analyzingPass) {
            $analyzedContainer = new \WPR_Vendor\Symfony\Component\DependencyInjection\ContainerBuilder();
    ...
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        if ($value instanceof \WPR_Vendor\Symfony\Component\DependencyInjection\Definition && $this->cloningIds) {
            if ($value->isShared()) {
                return $value;
            }
            $value = clone $value;
        ...
        if (isset($this->cloningIds[$id])) {
            ...
            $ids[] = $id;
            throw new \WPR_Vendor\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, \array_slice($ids, \array_search($id, $ids)));
        }
     ...
     */
    private function isInlineableDefinition(string $id, \WPR_Vendor\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
        ...
        if ($srcCount > 1 && \is_array($factory = $definition->getFactory()) && ($factory[0] instanceof \WPR_Vendor\Symfony\Component\DependencyInjection\Reference || $factory[0] instanceof \WPR_Vendor\Symfony\Component\DependencyInjection\Definition)) {
            return \false;
        }

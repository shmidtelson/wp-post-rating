 ...
 */
class ReplaceAliasByActualDefinitionPass extends \WPR_Vendor\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
        ...
        foreach ($container->getAliases() as $definitionId => $target) {
            ...
            try {
                ...
                if ('' !== $e->getId() && '@' === $e->getId()[0]) {
                    throw new \WPR_Vendor\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($e->getId(), $e->getSourceId(), null, [\substr($e->getId(), 1)]);
                }
                throw $e;
            }
    ...
    {
        if ($value instanceof \WPR_Vendor\Symfony\Component\DependencyInjection\Reference && isset($this->replacements[$referenceId = (string) $value])) {
            // Perform the replacement
            $newId = $this->replacements[$referenceId];
            $value = new \WPR_Vendor\Symfony\Component\DependencyInjection\Reference($newId, $value->getInvalidBehavior());

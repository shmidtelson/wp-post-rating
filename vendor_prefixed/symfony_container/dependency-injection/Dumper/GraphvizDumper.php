...
use WPR_Vendor\Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException;
 ...
 */
class GraphvizDumper extends \WPR_Vendor\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    private $nodes;
    private $edges;
    ...
    private function findEdges(string $id, array $arguments, bool $required, string $name, bool $lazy = \false) : array
    {
        ...
        foreach ($arguments as $argument) {
            if ($argument instanceof \WPR_Vendor\Symfony\Component\DependencyInjection\Parameter) {
                $argument = $this->container->hasParameter($argument) ? $this->container->getParameter($argument) : null;
            } elseif (\is_string($argument) && \preg_match('/^%([^%]+)%$/', $argument, $match)) {
                $argument = $this->container->hasParameter($match[1]) ? $this->container->getParameter($match[1]) : null;
            }
            if ($argument instanceof \WPR_Vendor\Symfony\Component\DependencyInjection\Reference) {
                $lazyEdge = $lazy;
            ...
            } elseif ($argument instanceof \WPR_Vendor\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
    ...
    private function findNodes() : array
    {
        ...
        foreach ($container->getDefinitions() as $id => $definition) {
            ...
            } catch (\WPR_Vendor\Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException $e) {
            }
            ...
            $container->setDefinition($id, new \WPR_Vendor\Symfony\Component\DependencyInjection\Definition('stdClass'));
        }
    ...
    private function cloneContainer() : \WPR_Vendor\Symfony\Component\DependencyInjection\ContainerBuilder
    {
        $parameterBag = new \WPR_Vendor\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->container->getParameterBag()->all());
        $container = new \WPR_Vendor\Symfony\Component\DependencyInjection\ContainerBuilder($parameterBag);

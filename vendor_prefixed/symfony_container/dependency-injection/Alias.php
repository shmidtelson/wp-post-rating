    ...
    public function setDeprecated()
    {
        ...
        if ('' !== $message) {
            ...
            if (\false === \strpos($message, '%alias_id%')) {
                throw new \WPR_Vendor\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException('The deprecation template must contain the "%alias_id%" placeholder.');
            }
        }

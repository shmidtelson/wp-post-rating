...
class ExprBuilder
{
    ...
    public $ifPart;
    public $thenPart;
    public function __construct(\WPR_Vendor\Symfony\Component\Config\Definition\Builder\NodeDefinition $node)
    {
        $this->node = $node;
    }
    /**
    ...
    {
        $this->thenPart = function ($v) {
            throw new \WPR_Vendor\Symfony\Component\Config\Definition\Exception\UnsetKeyException('Unsetting key.');
        };
        return $this;
    }
    /**

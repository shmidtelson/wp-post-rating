...
{
    private $reference;
    public function dump(\WPR_Vendor\Symfony\Component\Config\Definition\ConfigurationInterface $configuration, string $namespace = null)
    {
        return $this->dumpNode($configuration->getConfigTreeBuilder()->buildTree(), $namespace);
    }
    public function dumpNode(\WPR_Vendor\Symfony\Component\Config\Definition\NodeInterface $node, string $namespace = null)
    {
        $this->reference = '';
    ...
    private function writeNode(\WPR_Vendor\Symfony\Component\Config\Definition\NodeInterface $node, int $depth = 0, bool $root = \false, string $namespace = null)
    {
        ...
        if ($node instanceof \WPR_Vendor\Symfony\Component\Config\Definition\ArrayNode) {
            ...
            if ($node instanceof \WPR_Vendor\Symfony\Component\Config\Definition\PrototypedArrayNode) {
                ...
                if ($prototype instanceof \WPR_Vendor\Symfony\Component\Config\Definition\PrototypedArrayNode) {
                    $prototype->setName($key ?? '');
                    $children = [$key => $prototype];
                } elseif ($prototype instanceof \WPR_Vendor\Symfony\Component\Config\Definition\ArrayNode) {
            ...
            foreach ($children as $child) {
                if (!$child instanceof \WPR_Vendor\Symfony\Component\Config\Definition\ArrayNode) {
                    // get attributes
                    // metadata
                    ...
                    if ($child instanceof \WPR_Vendor\Symfony\Component\Config\Definition\EnumNode) {

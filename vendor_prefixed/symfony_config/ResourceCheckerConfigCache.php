...
use WPR_Vendor\Symfony\Component\Filesystem\Exception\IOException;
use WPR_Vendor\Symfony\Component\Filesystem\Filesystem;
/**
 ...
 */
class ResourceCheckerConfigCache implements \WPR_Vendor\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \WPR_Vendor\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\WPR_Vendor\Symfony\Component\Filesystem\Exception\IOException $e) {

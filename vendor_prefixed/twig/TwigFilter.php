...
final class TwigFilter
{
    ...
    public function __construct(string $name, $callable = null, array $options = [])
    {
        ...
        $this->options = \array_merge(['needs_environment' => \false, 'needs_context' => \false, 'is_variadic' => \false, 'is_safe' => null, 'is_safe_callback' => null, 'pre_escape' => null, 'preserves_safety' => null, 'node_class' => \WPR_Vendor\Twig\Node\Expression\FilterExpression::class, 'deprecated' => \false, 'alternative' => null], $options);
    }
    ...
    public function getSafe(\WPR_Vendor\Twig\Node\Node $filterArgs) : ?array
    {

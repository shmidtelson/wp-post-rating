...
EOF;
    ...
    private function dumpChildren(string $parent, \WPR_Vendor\Twig\Profiler\Profile $profile, &$data)
    {
    ...
    private function dumpProfile(string $edge, \WPR_Vendor\Twig\Profiler\Profile $profile, &$data)
    {
        if (isset($data[$edge])) {
            ++$data[$edge]['ct'];

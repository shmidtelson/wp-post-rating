 ...
 */
class WithNode extends \WPR_Vendor\Twig\Node\Node
{
    public function __construct(\WPR_Vendor\Twig\Node\Node $body, ?\WPR_Vendor\Twig\Node\Node $variables, bool $only, int $lineno, string $tag = null)
    {
        $nodes = ['body' => $body];
        if (null !== $variables) {

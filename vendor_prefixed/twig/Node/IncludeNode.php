 ...
 */
class IncludeNode extends \WPR_Vendor\Twig\Node\Node implements \WPR_Vendor\Twig\Node\NodeOutputInterface
{
    public function __construct(\WPR_Vendor\Twig\Node\Expression\AbstractExpression $expr, ?\WPR_Vendor\Twig\Node\Expression\AbstractExpression $variables, bool $only, bool $ignoreMissing, int $lineno, string $tag = null)
    {
        $nodes = ['expr' => $expr];
        if (null !== $variables) {
    ...
    protected function addGetTemplate(\WPR_Vendor\Twig\Compiler $compiler)
    {
    ...
    protected function addTemplateArguments(\WPR_Vendor\Twig\Compiler $compiler)
    {

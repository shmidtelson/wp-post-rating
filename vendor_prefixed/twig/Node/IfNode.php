 ...
 */
class IfNode extends \WPR_Vendor\Twig\Node\Node
{
    public function __construct(\WPR_Vendor\Twig\Node\Node $tests, ?\WPR_Vendor\Twig\Node\Node $else, int $lineno, string $tag = null)
    {
        $nodes = ['tests' => $tests];
        if (null !== $else) {
            $nodes['else'] = $else;

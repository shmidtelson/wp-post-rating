 ...
 */
class ForNode extends \WPR_Vendor\Twig\Node\Node
{
    private $loop;
    public function __construct(\WPR_Vendor\Twig\Node\Expression\AssignNameExpression $keyTarget, \WPR_Vendor\Twig\Node\Expression\AssignNameExpression $valueTarget, \WPR_Vendor\Twig\Node\Expression\AbstractExpression $seq, ?\WPR_Vendor\Twig\Node\Node $ifexpr, \WPR_Vendor\Twig\Node\Node $body, ?\WPR_Vendor\Twig\Node\Node $else, int $lineno, string $tag = null)
    {
        $body = new \WPR_Vendor\Twig\Node\Node([$body, $this->loop = new \WPR_Vendor\Twig\Node\ForLoopNode($lineno, $tag)]);

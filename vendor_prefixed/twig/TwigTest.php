...
final class TwigTest
{
    ...
    public function __construct(string $name, $callable = null, array $options = [])
    {
        ...
        $this->options = \array_merge(['is_variadic' => \false, 'node_class' => \WPR_Vendor\Twig\Node\Expression\TestExpression::class, 'deprecated' => \false, 'alternative' => null, 'one_mandatory_argument' => \false], $options);
    }

 ...
 */
class ReplaceAliasByActualDefinitionPass extends \WPR\Vendor\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
        ...
        foreach ($container->getAliases() as $definitionId => $target) {
            ...
            try {
                ...
                if ('' !== $e->getId() && '@' === $e->getId()[0]) {
                    throw new \WPR\Vendor\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($e->getId(), $e->getSourceId(), null, [\substr($e->getId(), 1)]);
                }
                throw $e;
            }
    ...
    {
        if ($value instanceof \WPR\Vendor\Symfony\Component\DependencyInjection\Reference && isset($this->replacements[$referenceId = (string) $value])) {
            // Perform the replacement
            $newId = $this->replacements[$referenceId];
            $value = new \WPR\Vendor\Symfony\Component\DependencyInjection\Reference($newId, $value->getInvalidBehavior());

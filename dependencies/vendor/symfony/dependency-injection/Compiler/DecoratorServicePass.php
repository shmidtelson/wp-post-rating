 ...
 */
class DecoratorServicePass extends \WPR\Vendor\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    ...
    public function process(\WPR\Vendor\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($definitions as list($id, $definition)) {
            ...
            $invalidBehavior = $decoratedService[3] ?? \WPR\Vendor\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE;
            ...
            if ($container->hasAlias($inner)) {
                ...
                $container->setAlias($renamedId, new \WPR\Vendor\Symfony\Component\DependencyInjection\Alias((string) $alias, \false));
                ...
                continue;
            } elseif (\WPR\Vendor\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE === $invalidBehavior) {
                $public = $definition->isPublic();
                $private = $definition->isPrivate();
            } else {
                throw new \WPR\Vendor\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($inner, $id);
            }
    ...
    {
        if ($value instanceof \WPR\Vendor\Symfony\Component\DependencyInjection\Reference && $this->innerId === (string) $value) {
            return new \WPR\Vendor\Symfony\Component\DependencyInjection\Reference($this->currentId, $value->getInvalidBehavior());
        }

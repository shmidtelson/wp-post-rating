 ...
 */
class AnalyzeServiceReferencesPass extends \WPR\Vendor\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    private $graph;
    ...
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        if ($value instanceof \WPR\Vendor\Symfony\Component\DependencyInjection\Reference) {
            ...
            $this->graph->connect($this->currentId, $this->currentDefinition, $targetId, $targetDefinition, $value, $this->lazy || $this->hasProxyDumper && $targetDefinition && $targetDefinition->isLazy(), \WPR\Vendor\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_UNINITIALIZED_REFERENCE === $value->getInvalidBehavior(), $this->byConstructor);
            if ($inExpression) {

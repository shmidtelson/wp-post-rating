 ...
 */
class CheckArgumentsValidityPass extends \WPR\Vendor\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
            ...
            if ($k !== $i++) {
                if (!\is_int($k)) {
                    ...
                    if ($this->throwExceptions) {
                        throw new \WPR\Vendor\Symfony\Component\DependencyInjection\Exception\RuntimeException($msg);
                    }
                    break;
                }

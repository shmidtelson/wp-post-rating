 ...
 */
class ResolveHotPathPass extends \WPR\Vendor\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    private $tagName;
    private $resolvedIds = [];
    ...
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        if ($value instanceof \WPR\Vendor\Symfony\Component\DependencyInjection\Definition && $isRoot) {
        ...
        if ($value instanceof \WPR\Vendor\Symfony\Component\DependencyInjection\Reference && \WPR\Vendor\Symfony\Component\DependencyInjection\ContainerBuilder::IGNORE_ON_UNINITIALIZED_REFERENCE !== $value->getInvalidBehavior() && $this->container->hasDefinition($id = (string) $value)) {

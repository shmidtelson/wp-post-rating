...
final class ReverseContainer
{
    ...
    public function __construct(\WPR\Vendor\Symfony\Component\DependencyInjection\Container $serviceContainer, \WPR\Vendor\Psr\Container\ContainerInterface $reversibleLocator, string $tagName = 'container.reversible')
    {
        ...
        }, $serviceContainer, \WPR\Vendor\Symfony\Component\DependencyInjection\Container::class);
    }
    /**
    ...
    public function getService(string $id) : object
    {
        ...
        if (isset($this->serviceContainer->getRemovedIds()[$id])) {
            throw new \WPR\Vendor\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, null, null, [], \sprintf('The "%s" service is private and cannot be accessed by reference. You should either make it public, or tag it as "%s".', $id, $this->tagName));
        }

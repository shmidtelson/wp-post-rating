...
use WPR\Vendor\Symfony\Component\Finder\Finder;
use WPR\Vendor\Symfony\Component\Finder\Glob;
/**
 ...
 * @final
 */
class GlobResource implements \IteratorAggregate, \WPR\Vendor\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    private $prefix;
    private $pattern;
    private $recursive;
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\WPR\Vendor\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \WPR\Vendor\Symfony\Component\Finder\Finder();
        $regex = \WPR\Vendor\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {

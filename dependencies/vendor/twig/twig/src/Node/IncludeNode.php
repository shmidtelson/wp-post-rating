 ...
 */
class IncludeNode extends \WPR\Vendor\Twig\Node\Node implements \WPR\Vendor\Twig\Node\NodeOutputInterface
{
    public function __construct(\WPR\Vendor\Twig\Node\Expression\AbstractExpression $expr, ?\WPR\Vendor\Twig\Node\Expression\AbstractExpression $variables, bool $only, bool $ignoreMissing, int $lineno, string $tag = null)
    {
        $nodes = ['expr' => $expr];
        if (null !== $variables) {
    ...
    protected function addGetTemplate(\WPR\Vendor\Twig\Compiler $compiler)
    {
    ...
    protected function addTemplateArguments(\WPR\Vendor\Twig\Compiler $compiler)
    {

 ...
 */
class SetNode extends \WPR\Vendor\Twig\Node\Node implements \WPR\Vendor\Twig\Node\NodeCaptureInterface
{
    public function __construct(bool $capture, \WPR\Vendor\Twig\Node\Node $names, \WPR\Vendor\Twig\Node\Node $values, int $lineno, string $tag = null)
    {
        ...
        if ($this->getAttribute('capture')) {
            ...
            if ($values instanceof \WPR\Vendor\Twig\Node\TextNode) {
                $this->setNode('values', new \WPR\Vendor\Twig\Node\Expression\ConstantExpression($values->getAttribute('data'), $values->getTemplateLine()));

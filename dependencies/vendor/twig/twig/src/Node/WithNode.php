 ...
 */
class WithNode extends \WPR\Vendor\Twig\Node\Node
{
    public function __construct(\WPR\Vendor\Twig\Node\Node $body, ?\WPR\Vendor\Twig\Node\Node $variables, bool $only, int $lineno, string $tag = null)
    {
        $nodes = ['body' => $body];
        if (null !== $variables) {

 ...
 */
final class ModuleNode extends \WPR\Vendor\Twig\Node\Node
{
    public function __construct(\WPR\Vendor\Twig\Node\Node $body, ?\WPR\Vendor\Twig\Node\Expression\AbstractExpression $parent, \WPR\Vendor\Twig\Node\Node $blocks, \WPR\Vendor\Twig\Node\Node $macros, \WPR\Vendor\Twig\Node\Node $traits, $embeddedTemplates, \WPR\Vendor\Twig\Source $source)
    {
        $nodes = ['body' => $body, 'blocks' => $blocks, 'macros' => $macros, 'traits' => $traits, 'display_start' => new \WPR\Vendor\Twig\Node\Node(), 'display_end' => new \WPR\Vendor\Twig\Node\Node(), 'constructor_start' => new \WPR\Vendor\Twig\Node\Node(), 'constructor_end' => new \WPR\Vendor\Twig\Node\Node(), 'class_end' => new \WPR\Vendor\Twig\Node\Node()];
        if (null !== $parent) {
            $nodes['parent'] = $parent;
        }
    ...
    protected function compileTemplate(\WPR\Vendor\Twig\Compiler $compiler)
    {
    ...
    protected function compileGetParent(\WPR\Vendor\Twig\Compiler $compiler)
    {
    ...
    protected function compileClassHeader(\WPR\Vendor\Twig\Compiler $compiler)
    {
        $compiler->write("\n\n");
        if (!$this->getAttribute('index')) {
    ...
    protected function compileConstructor(\WPR\Vendor\Twig\Compiler $compiler)
    {
    ...
    protected function compileDisplay(\WPR\Vendor\Twig\Compiler $compiler)
    {
    ...
    protected function compileClassFooter(\WPR\Vendor\Twig\Compiler $compiler)
    {
        $compiler->subcompile($this->getNode('class_end'))->outdent()->write("}\n");
    }
    protected function compileMacros(\WPR\Vendor\Twig\Compiler $compiler)
    {
        $compiler->subcompile($this->getNode('macros'));
    }
    protected function compileGetTemplateName(\WPR\Vendor\Twig\Compiler $compiler)
    {
        $compiler->write("public function getTemplateName()\n", "{\n")->indent()->write('return ')->repr($this->getSourceContext()->getName())->raw(";\n")->outdent()->write("}\n\n");
    }
    protected function compileIsTraitable(\WPR\Vendor\Twig\Compiler $compiler)
    {
        ...
        if ($traitable) {
            if ($this->getNode('body') instanceof \WPR\Vendor\Twig\Node\BodyNode) {
                $nodes = $this->getNode('body')->getNode(0);
            } else {
                $nodes = $this->getNode('body');
            }
            if (!\count($nodes)) {
                $nodes = new \WPR\Vendor\Twig\Node\Node([$nodes]);
            }
            foreach ($nodes as $node) {
                ...
                if ($node instanceof \WPR\Vendor\Twig\Node\BlockReferenceNode) {
                    continue;
                }
                $traitable = \false;
                break;
    ...
    protected function compileDebugInfo(\WPR\Vendor\Twig\Compiler $compiler)
    {
        $compiler->write("public function getDebugInfo()\n", "{\n")->indent()->write(\sprintf("return %s;\n", \str_replace("\n", '', \var_export(\array_reverse($compiler->getDebugInfo(), \true), \true))))->outdent()->write("}\n\n");
    }
    protected function compileGetSourceContext(\WPR\Vendor\Twig\Compiler $compiler)
    {
    ...
    protected function compileLoadTemplate(\WPR\Vendor\Twig\Compiler $compiler, $node, $var)
    {
        if ($node instanceof \WPR\Vendor\Twig\Node\Expression\ConstantExpression) {

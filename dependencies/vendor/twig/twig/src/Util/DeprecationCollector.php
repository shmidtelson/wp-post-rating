 ...
 */
namespace WPR\Vendor\Twig\Util;
...
{
    private $twig;
    public function __construct(\WPR\Vendor\Twig\Environment $twig)
    {
        $this->twig = $twig;
    }
    /**
    ...
    public function collectDir(string $dir, string $ext = '.twig') : array
    {
        ...
        return $this->collect(new \WPR\Vendor\Twig\Util\TemplateDirIterator($iterator));
    }
    /**
    ...
    public function collect(\Traversable $iterator) : array
    {
        ...
        foreach ($iterator as $name => $contents) {
            try {
                $this->twig->parse($this->twig->tokenize(new \WPR\Vendor\Twig\Source($contents, $name)));

...
use WPR\Vendor\Twig\Extension\GlobalsInterface;
use WPR\Vendor\Twig\Extension\StagingExtension;
...
final class ExtensionSet
{
    ...
    {
        $this->staging = new \WPR\Vendor\Twig\Extension\StagingExtension();
    }
    ...
    public function getExtension(string $class) : \WPR\Vendor\Twig\Extension\ExtensionInterface
    {
        ...
        if (!isset($this->extensions[$class])) {
            throw new \WPR\Vendor\Twig\Error\RuntimeError(\sprintf('The "%s" extension is not enabled.', $class));
        }
    ...
    public function addExtension(\WPR\Vendor\Twig\Extension\ExtensionInterface $extension) : void
    {
    ...
    public function getGlobals() : array
    {
        ...
        $globals = [];
        foreach ($this->extensions as $extension) {
            if (!$extension instanceof \WPR\Vendor\Twig\Extension\GlobalsInterface) {
                continue;
            }
    ...
    private function initExtension(\WPR\Vendor\Twig\Extension\ExtensionInterface $extension) : void
    {
        // filters
        ...
        foreach ($extension->getTokenParsers() as $parser) {
            if (!$parser instanceof \WPR\Vendor\Twig\TokenParser\TokenParserInterface) {

...
final class TwigFunction
{
    ...
    public function __construct(string $name, $callable = null, array $options = [])
    {
        ...
        $this->options = \array_merge(['needs_environment' => \false, 'needs_context' => \false, 'is_variadic' => \false, 'is_safe' => null, 'is_safe_callback' => null, 'node_class' => \WPR\Vendor\Twig\Node\Expression\FunctionExpression::class, 'deprecated' => \false, 'alternative' => null], $options);
    }
    ...
    public function getSafe(\WPR\Vendor\Twig\Node\Node $functionArgs) : ?array
    {
